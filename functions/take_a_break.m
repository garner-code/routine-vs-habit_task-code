function [] = take_a_break(window, count_trials, ntrials, breaks, backRect, xCenter, yCenter, screenYpixels, tpoints, ...
    stage, feedback, points_structure, badge_rects, badge_tex)
...
if stage == 20 % only actually want points feedback in the second stage
...
elseif stage == 3
    ...
    instructions = ...
        ...
        '%d/%d blocks complete\n'...
        '\n'...
        'You got it in 4 moves or less %.2f percent of the time, and\n'...
        'your average time to pick a door is %.2f seconds\n' ...
        'Take a break...you earned it\n\n\n'...
        'Press any key to continue.\n'], (count_trials/breaks), (ntrials/breaks), ...
        feedback.acc*100, round(feedback.rt,2));
else
    instructions = ...
        sprintf([this_pun '\n\n'...
        'You are doing great!\n'...
